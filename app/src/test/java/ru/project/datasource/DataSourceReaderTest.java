...
class DataSourceReaderTest{
    ...
    void readerTestRejectRelativePath(){
        assertThrows(IllegalArgumentException.class, () -> new StudentCsvReader("/Users/Dexp/TestData/sample.csv"));
    }

    @Test
    void readerRejectPathIsDir(){
        assertThrows(UncheckedIOException.class, () -> new StudentCsvReader("C:\\Users\\Dexp\\TestData"));
    }

    @Test
    void readerTestFileNotExist(){
        assertThrows(UncheckedIOException.class, () -> new StudentCsvReader("C:\\Users\\Dexp\\TestData\\sss.csv"));
    }
    ...
    void readerTestRejectFewParametres(){
        assertThrows(IllegalArgumentException.class, () -> {
            StudentCsvReader reader = new StudentCsvReader("C:\\Users\\Dexp\\TestData\\fewparameters.csv");
    ...
    void readerTestRejectInvalidGroupNumber(){
        assertThrows(IllegalArgumentException.class, () -> {
            StudentCsvReader reader = new StudentCsvReader("C:\\Users\\Dexp\\TestData\\invalid_groupnumber.csv");
            Student student = reader.next();
        });
    }
    ...
    void readerTestRejectInvalidAverageGrade(){
        assertThrows(IllegalArgumentException.class, () -> {
            StudentCsvReader reader = new StudentCsvReader("C:\\Users\\Dexp\\TestData\\invalid_averagegrade.csv");
            Student student = reader.next();
        });
    }
    ...
    void readerTestRejectInvalidRecordBookNumber(){
        assertThrows(IllegalArgumentException.class, () -> {
            StudentCsvReader reader = new StudentCsvReader("C:\\Users\\Dexp\\TestData\\invalid_recordbooknumber.csv");
            Student student = reader.next();
        });
    }
}